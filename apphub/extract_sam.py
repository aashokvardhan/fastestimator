...
class TwoWayTransformer(nn.Module):
    def __init__(
        ...
        self.final_attn_token_to_image = AttentionDS(embedding_dim, num_heads, downsample_rate=attention_downsample_rate)
...
class TwoWayAttentionBlock(nn.Module):
    def __init__(
        ...
        """
        super().__init__()
        self.self_attn = AttentionDS(embedding_dim, num_heads)
        self.norm1 = nn.LayerNorm(embedding_dim)

        self.cross_attn_token_to_image = AttentionDS(embedding_dim, num_heads, downsample_rate=attention_downsample_rate)
        ...
        self.cross_attn_image_to_token = AttentionDS(embedding_dim, num_heads, downsample_rate=attention_downsample_rate)
...
if __name__ == "__main__":
    model = build_sam_vit_b(checkpoint="/raid/shared_data/segment-anything/weights/sam_vit_b_01ec64.pth")
    torch.save(model.image_encoder.state_dict(), "sam_encoder_b.pth")
